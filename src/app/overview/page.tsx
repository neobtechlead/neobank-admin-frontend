...
import DashboardCardItem from "@/app/overview/components/DashBoardCardItem";
import PieChartCard from "@/app/overview/components/PieChartCard";
import DashBoardTable from "@/app/overview/components/DashBoardTable";
...
import DashBoardSkeleton from "@/app/overview/loading";
    ...
    return (
        <Flex direction="column" gap="6" my="7" px="6">
            ...
            <Flex gap="6">
                ...
                <DashBoardTable href="/customers" description="Last 10 registered customers"
                                data={mapDataToCustomerTable(customerData!)}/>
            </Flex>
            <Flex gap="6">
                <DashBoardTable href="/merchants" description="Last 10 merchants onboarded"
